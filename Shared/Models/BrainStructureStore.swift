...
struct BrainStructureStore {
    static let all: [BrainStructure] = [
        ...
        BrainStructure(
            ...
            clinicalSignificance: "Lesions can cause dystonia (sustained involuntary muscle contractions) or hemiballismus (violent flinging movements of contralateral limbs). Deep brain stimulation of GPi is a treatment for Parkinson's and dystonia.",
            associatedDisorders: ["Dystonia", "Hemiballismus", "Parkinson's Disease"],
