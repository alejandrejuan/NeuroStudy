    ...
    static let all: [Pathology] = [
        ...
        Pathology(
            ...
            dsm5Criteria: DSM5CriteriaData(
                ...
                criterionBCDE: "Criterion A has TWO independent domains of nine symptoms each (inattention; hyperactivity–impulsivity). A diagnosis requires ≥6 symptoms within a SINGLE domain (≥5 for individuals 17 and older), not 6 spread across both. B: Several symptoms present before age 12. C: Symptoms present in two or more settings. D: Clear evidence symptoms interfere with functioning. E: Not better explained by another disorder. Wording here is an original paraphrase of the DSM-5-TR criteria for study purposes, not a reproduction.",
                specifiers: [
        ...
        Pathology(
            ...
            dsm5Criteria: DSM5CriteriaData(
                ...
                criterionBCDE: "At least TWO of the five symptoms must be present, and at least ONE of them must be a core positive symptom — delusions, hallucinations, or disorganized speech. B: Social/occupational dysfunction for a significant portion of time since onset. C: Continuous signs for ≥6 months. D: Not schizoaffective or a mood disorder with psychotic features. E: Not due to a substance or medical condition. F: If autism/communication disorder history, diagnosed only with prominent delusions or hallucinations for ≥1 month. Wording is an original paraphrase of DSM-5-TR for study use.",
                specifiers: [
        ...
        Pathology(
            ...
            dsm5Criteria: DSM5CriteriaData(
                ...
                criterionBCDE: "B: The obsessions or compulsions are time-consuming or cause significant distress or impairment. C: Not attributable to a substance or medical condition. D: Not better explained by another mental disorder. Specify insight (good/fair, poor, or absent/delusional) and whether tic-related. Wording is an original paraphrase of DSM-5-TR for study use.",
                specifiers: [
        ...
        Pathology(
            ...
            dsm5Criteria: DSM5CriteriaData(
                ...
                criterionBCDE: "Criterion A requires ALL THREE social-communication deficits above. B: also requires ≥2 of 4 restricted/repetitive patterns — (1) stereotyped movement, speech, or object use, (2) insistence on sameness or rigid routines, (3) intensely fixated, narrow interests, (4) over- or under-reactivity to sensory input. C: present in early development. D: causes meaningful impairment. E: not better explained by intellectual disability or global developmental delay. Wording is an original paraphrase of DSM-5-TR for study use.",
                specifiers: [
